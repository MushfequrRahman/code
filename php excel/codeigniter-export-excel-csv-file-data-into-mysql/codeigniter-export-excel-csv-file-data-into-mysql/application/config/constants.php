...
define('DB_PASSWORD', '');
define('DB_NAME', 'techarise_DB');
// windows path
//define('BASH_PATH', 'C:/xampp/htdocs/codeigniter-export-excel-csv-file-data-into-mysql/');
// Ubuntu path
//define('BASH_PATH', '/var/www/codeigniter-export-excel-csv-file-data-into-mysql/');
// Mac Path
define('BASH_PATH', '/Applications/XAMPP/htdocs/codeigniter-export-excel-csv-file-data-into-mysql/');
