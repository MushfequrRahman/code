            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <td><a target="_blank" href="<?php echo base_url().'assets/uploads/notice/'.$row['nfname'];?>"><i class="fa fa-file"></i></a></td>
                  <td style="vertical-align:middle;"><?php echo date('d-m-Y',strtotime($row['ndate']));?></td>
