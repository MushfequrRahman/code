...
$mail->addCC('Humayun_env@mascoknit.com');
$mail->addCC('Faisal_dye@mascoknit.com');
$mail->addCC('Wasim_ckl@mascoknit.com');
...
$mail->Body    = 'Please follow the above attached pdf license file and need to renewal within timeline.For more details visit the link,http://192.168.50.70/masco_license/.This mail auto generate please donot reply.';
$mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
$mail->addAttachment('C:\Users\Administrator\Downloads\masco_license.pdf'); // Optional name
